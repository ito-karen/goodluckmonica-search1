...
<c:forEach var="product" items="${productlist}">
    ...
    <p><c:out value="${product.stock.stockQuantity}"/></p>
    <p><a href='${pageContext.request.contextPath}/mserv?flag=B0101AddToCart&productId=<c:out value="${product.productId}"/>'>カートに入れる</a></p>
</c:forEach>
</c:if>
</div>--%>
